...
const SCRIPT_URL = "https://script.google.com/macros/s/AKfycbzbSRoiJgMOEH4QhoBYk6tyus4Ds07DG-18NzwP4MBuweHrKahcvQ7202ddXkwI3v2eFg/exec";
...
// Boys left blank — Imee doesn't have a co-leader yet. Once one is
// assigned, just fill in his name here and the Boys door will appear
  ...
  return (
    <div className="home-wrap">
      <div className="home-hero">
        <span className="eyebrow">Imee Patal's Cell Report</span>
    ...
    <div className="shell" data-textsize={textSize}>
      ...
      <header className="topbar">
        <button className="brand" onClick={goHome}>
          ...
          <span className="brand-name">Imee Patal's Cell Report</span>
        </button>
